...
def num_col(data:pd.DataFrame) -> pd.DataFrame:
...
def cat_col(data:pd.DataFrame) -> pd.DataFrame:
...
# Workflow
@flow
def main(path: str=r'data\diamonds.csv'):
    ...
    Categorical_test_df=cat_col(train_test_dict['X_TEST'])
